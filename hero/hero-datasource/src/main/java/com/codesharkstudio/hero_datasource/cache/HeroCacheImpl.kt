package com.codesharkstudio.hero_datasource.cache

import com.codesharkstudio.domain.Hero
import com.codesharkstudio.domain.HeroRole
import com.codesharkstudio.hero_datasource.cache.model.toHero
import com.codesharkstudio.herodatasource.cache.HeroDbQueries
    ...
    override suspend fun insert(hero: Hero) {
        return hero.run {
            queries.insertHero(
                ...
                turnRate = turnRate?.toDouble() ?: 0.0,
                legs = legs?.toLong() ?: 0,
